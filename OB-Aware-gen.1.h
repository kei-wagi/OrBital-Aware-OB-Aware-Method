...
public:
  ...
  static void SetSpecialAddresses (const std::string& antenna, const std::string& groundStation);



  void CollectOrbitCandidates(Ipv4Address sender, double timeDifference);
  void MakeOrbitDecision(Ipv4Address sender);
...
private:
   ...
   * \param src sender address
  */
  void TableUpdateREQ (Ptr<Packet> p, Ipv4Address receiver, Ipv4Address src);
  /**
   * Receive RREP
   * \param p packet
   * \param my destination address
  ...
  */
   ...
   */
    void TableUpdateREP (Ptr<Packet> p, Ipv4Address my, Ipv4Address src);
  /**
   * Receive RREP_ACK
   * \param neighbor neighbor address
   */
   ...
   */
    void SendRequest2 (Ipv4Address dst);
  /** Send RREP
   * \param rreqHeader route request header
   * \param toOrigin routing table entry to originator
   */
